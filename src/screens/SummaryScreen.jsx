    ...
    <div className="flex flex-col min-h-screen bg-neutral-50 dark:bg-slate-900 transition-colors">
      ...
      <div className="px-6 pt-2">
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-neutral-100 dark:border-slate-700 p-5">
          ...
          <div className="mt-4 flex items-center gap-2 bg-warning-50 dark:bg-warning-900/20 rounded-xl px-4 py-3">
            <svg
              className="w-5 h-5 text-warning-500 dark:text-warning-400 shrink-0"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={1.5}
        ...
        <div className="space-y-3 pb-6">
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <svg
                    className="w-5 h-5 text-neutral-300 dark:text-neutral-600 mt-1"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
          ...
          <div className="bg-warning-50 dark:bg-warning-900/20 rounded-2xl border border-warning-100 dark:border-warning-800 p-5">
            <div className="flex items-start gap-3">
              <svg
                className="w-5 h-5 text-warning-600 dark:text-warning-400 shrink-0 mt-0.5"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
              ...
              <div>
                ...
                <p className="text-xs text-warning-700 dark:text-warning-300 leading-relaxed">
                  ព័ត៌មាននេះមានគោលបំណងជួយអ្នកយល់ដឹងបន្ថែមអំពីគំនិត
                  និងគោលការណ៍ណែនាំសុខភាព។
                  សូមប្រឹក្សាជាមួយគ្រូពេទ្យជំនាញជានិច្ចសម្រាប់ដំបូន្មានវេជ្ជសាស្រ្ត
                  ការធ្វើរោគវិនិច្ឆ័យ ឬការព្យាបាល។
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="space-y-3">
          <p>
            ទំព័រនេះបង្ហាញលទ្ធផលសង្ខេបពីរបាយការណ៍សុខភាពរបស់អ្នក។
            រាល់ចំណុចបង្ហាញដោយពណ៌៖
          </p>
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              <span className="w-2 h-2 bg-success-500 rounded-full mt-2 shrink-0" />
              <span>
                <strong>ខៀវ / បៃតង</strong> — លទ្ធផលស្ថិតក្នុងដែនកំណត់ធម្មតា
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-2 h-2 bg-warning-500 rounded-full mt-2 shrink-0" />
              <span>
                <strong>លឿង</strong> — លទ្ធផលខ្ពស់ឬទាបបន្តិច ត្រូវយកចិត្តទុកដាក់
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-2 h-2 bg-error-500 rounded-full mt-2 shrink-0" />
              <span>
                <strong>ក្រហម</strong> — លទ្ធផលខ្ពស់ឬទាបច្រើន
                សូមប្រឹក្សាគ្រូពេទ្យ
              </span>
            </li>
          </ul>
          <p>
            <strong>AI confidence</strong>{" "}
            បង្ហាញកម្រិតទំនុកចិត្តរបស់ប្រព័ន្ធក្នុងការបកប្រែតម្លៃនីមួយៗ។
            ប្រសិនបើអ្នកមានសំណួរ សូមចុចលើចំណុចណាមួយដើម្បីអានបរិយាយលម្អិត។
          </p>
        </div>
      </HelpBottomSheet>
