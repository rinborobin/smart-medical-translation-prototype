...
export default function QRCodeScreen({ onGoBack, language = "kh" }) {
      ...
      <div className="flex items-center gap-3 px-6 pt-14 pb-4">
        ...
        <div>
          <h1 className="text-lg font-semibold text-neutral-900 dark:text-white">
            {t("QR បញ្ចូលជាអ្នកថែទាំ", "QR for Adding Caregiver")}
          </h1>
          <p className="text-xs text-neutral-400 dark:text-neutral-500">
            {t("QR for Adding Caregiver", "QR for Adding Caregiver")}
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              <p className="text-lg font-bold text-neutral-900 dark:text-white">
                {t("សុខា រីក", "Sokha Riek")}
              </p>
              <p className="text-sm text-neutral-400 dark:text-neutral-500">
                sokha.reak@email.com
              </p>
            </div>
            ...
            <p className="text-sm text-neutral-500 dark:text-neutral-400 text-center leading-relaxed">
              {t(
                "សួរអ្នកថែទាំស្កេន QR នេះ",
                "Ask the caregiver to scan this QR",
              )}
              <br />
              {t(
                "ដើម្បីបញ្ចូលអ្នកជាអ្នកតាមដានសុខភាព",
                "to add you as a health tracker",
              )}
            </p>
          </div>
        </div>
